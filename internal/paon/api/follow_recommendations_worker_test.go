...
func TestFollowRecommendationsWorkerUsesRailsSchedulerShape(t *testing.T) {
	...
	checks := []struct {
		...
		{"refreshFollowRecommendationMaterializedViews", `REFRESH MATERIALIZED VIEW account_summaries`},
		{"refreshFollowRecommendationMaterializedViews", `REFRESH MATERIALIZED VIEW global_follow_recommendations`},
