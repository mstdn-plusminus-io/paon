...
func TestMediaVacuumWorkerUsesRailsMediaAttachmentsVacuumShape(t *testing.T) {
	...
	checks := []struct {
		...
		{"mediaAttachmentsWithoutLocalInteraction", `favourites.status_id = media_attachments.status_id`},
		{"mediaAttachmentsWithoutLocalInteraction", `bookmarks.status_id = media_attachments.status_id`},
		{"mediaAttachmentsWithoutLocalInteraction", `interactions.in_reply_to_id = media_attachments.status_id`},
		{"mediaAttachmentsWithoutLocalInteraction", `interactions.reblog_of_id = media_attachments.status_id`},
		{"mediaAttachmentsWithoutLocalInteraction", `quotes.quoted_status_id = media_attachments.status_id`},
		{"mediaAttachmentsWithoutLocalInteraction", `quotes.status_id = media_attachments.status_id`},
