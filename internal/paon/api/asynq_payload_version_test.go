...
func TestAllAsynqPayloadShapesEmitCurrentVersion(t *testing.T) {
	payloads := []struct {
		...
		{name: "email subscription", payload: asynqEmailSubscriptionPayload{}},
...
func TestEveryRegisteredAsynqHandlerRejectsUnknownFuturePayload(t *testing.T) {
	taskTypes := []string{
		...
		asynqTaskEmailSubscriptionConfirmation,
		asynqTaskEmailSubscriptionDistribution,
		asynqTaskEmailSubscriptionDelivery,
