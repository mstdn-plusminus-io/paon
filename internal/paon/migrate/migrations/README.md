...
The `4.3.23`, `4.4.22`, `4.5.15`, and `4.6.6` directories contain the
upstream migration IDs introduced by each release. `paon-migrate` embeds these
...
The 4.6 `_index.sql` file runs after the Go duplicate backfill. These supporting
files never create additional `schema_migrations` entries. Do not run the SQL
