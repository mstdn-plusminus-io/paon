...
-- paon:statement
ALTER TABLE "devices" ADD CONSTRAINT "fk_rails_a796b75798" FOREIGN KEY ("account_id") REFERENCES "accounts" (id) ON DELETE CASCADE;

-- paon:statement
ALTER TABLE "devices" ADD CONSTRAINT "fk_rails_393f74df68" FOREIGN KEY ("access_token_id") REFERENCES "oauth_access_tokens" (id) ON DELETE CASCADE;
...
-- paon:statement
ALTER TABLE "encrypted_messages" ADD CONSTRAINT "fk_rails_a42ad0f8d5" FOREIGN KEY ("from_account_id") REFERENCES "accounts" (id) ON DELETE CASCADE;

-- paon:statement
ALTER TABLE "encrypted_messages" ADD CONSTRAINT "fk_rails_a83e4df7ae" FOREIGN KEY ("device_id") REFERENCES "devices" (id) ON DELETE CASCADE;
...
-- paon:statement
ALTER TABLE "one_time_keys" ADD CONSTRAINT "fk_rails_d3edd8c878" FOREIGN KEY ("device_id") REFERENCES "devices" (id) ON DELETE CASCADE;
...
-- paon:statement
INSERT INTO ar_internal_metadata (key, value, created_at, updated_at) VALUES ('schema_sha1', '7d5086228b379c66ff21a4396f443ba4daac5752', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
