...
func RequiredMastodonForeignKeys() []MastodonForeignKey {
	return []MastodonForeignKey{
		...
		{Table: "account_moderation_notes", Column: "account_id", ForeignTable: "accounts", OnDelete: "a", Name: "fk_rails_3f8b75089b"},
		{Table: "account_moderation_notes", Column: "target_account_id", ForeignTable: "accounts", OnDelete: "a", Name: "fk_rails_dd62ed5ac3"},
		...
		{Table: "imports", Column: "account_id", ForeignTable: "accounts", OnDelete: "c", Name: "fk_6db1b6e408"},
		...
		{Table: "webauthn_credentials", Column: "user_id", ForeignTable: "users", OnDelete: "a", Name: "fk_rails_a4355aef77"},
	}
}
