...
class StatusActionBar extends ImmutablePureComponent {
  ...
  render () {
    ...
    const quoteTitle = intl.formatMessage(messages.quote);
    ...
    return (
      <div className='status__action-bar'>
        ...
        <IconButton className='status__action-bar__button quote-icon' disabled={!quoteableStatus} title={quoteTitle} icon='quote-right' iconComponent={FormatQuoteIcon} onClick={this.handleQuoteClick} counter={withCounters ? status.get('quotes_count') : undefined} />
