  ...
  render () {
    ...
    return (
      <div>
        ...
        <div role='group' aria-labelledby='notifications-quote'>
          <span id='notifications-quote' className='column-settings__section'><FormattedMessage id='notifications.column_settings.quote' defaultMessage='Quotes:' /></span>
