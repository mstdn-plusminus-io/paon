    ...
    <div className='modal-root__modal safety-action-modal'>
      <div className='safety-action-modal__top'>
        ...
        <div className='safety-action-modal__bullet-points'>
          ...
          <div>
            ...
            <div><FormattedMessage id='block_modal.you_wont_see_mentions' defaultMessage="You won't see posts that mention them." /></div>
          </div>
      ...
      <div className={classNames('safety-action-modal__bottom', { active: expanded })}>
        ...
        <div className='safety-action-modal__actions'>
          {domain && (
            <button onClick={handleToggleLearnMore} className='link-button' aria-expanded={expanded}>
