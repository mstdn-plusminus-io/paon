...
const close = () => closeModal({ modalType: undefined, ignoreFocus: false });
...
export const DomainBlockModal: React.FC<{
  ...
  useEffect(() => {
    ...
    void apiRequest<DomainBlockPreviewResponse>(
      'GET',
      'v1/domain_blocks/preview',
      {
        params: { domain },
        timeout: 5000,
      },
      ...
      <div className='safety-action-modal__top'>
        <div className='safety-action-modal__header'>
          <div className='safety-action-modal__header__icon'>
            <Icon id='domain-disabled' icon={DomainDisabledIcon} />
          </div>
        ...
        <div className='safety-action-modal__bullet-points'>
          ...
          <div className='safety-action-modal__bullet-points--deemphasized'>
            <div className='safety-action-modal__bullet-points__icon'>
              <Icon id='campaign' icon={CampaignIcon} />
            </div>
            <div>
              <FormattedMessage
          ...
          <div className='safety-action-modal__bullet-points--deemphasized'>
            <div className='safety-action-modal__bullet-points__icon'>
              <Icon id='history' icon={HistoryIcon} />
            </div>
            <div>
              <FormattedMessage
